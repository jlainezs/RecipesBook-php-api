 ...
 */
final class Version20260712205035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe_ingredient (quantity REAL NOT NULL, ordering INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id UUID NOT NULL, recipe_id UUID DEFAULT NULL, ingredient_id UUID DEFAULT NULL, unit_of_measure_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD CONSTRAINT FK_22D1FE13DA4E2C90 FOREIGN KEY (unit_of_measure_id) REFERENCES unit_of_measure (id)');
    }
