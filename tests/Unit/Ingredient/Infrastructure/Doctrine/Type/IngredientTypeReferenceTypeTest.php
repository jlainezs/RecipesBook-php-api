<?php
namespace App\Tests\Unit\Ingredient\Infrastructure\Doctrine\Type;
...
class IngredientTypeReferenceTypeTest extends TestCase
{
    private IngredientTypeReferenceType $type;
    private AbstractPlatform $platform;

    public function setUp(): void
    {
        $this->type = new IngredientTypeReferenceType();
    ...
    {
        $this->assertSame('ingredient_type_reference', IngredientTypeReferenceType::NAME);
        $this->assertSame(IngredientTypeReferenceType::NAME, $this->type->getName());
    }
    ...
    public function it_converts_an_uuid_to_an_ingredient_reference(string $uuid): void
    {
        ...
        $this->assertInstanceOf(IngredientTypeReference::class, $ref);
    ...
    public function it_converts_to_database_value(string $value): void
    {
        $this->assertSame($value,
            $this->type->convertToDatabaseValue(new IngredientTypeReference($value), $this->platform)
        );
    }
