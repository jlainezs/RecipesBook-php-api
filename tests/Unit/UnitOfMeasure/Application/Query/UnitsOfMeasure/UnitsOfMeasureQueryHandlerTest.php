...
use App\UnitOfMeasure\Application\Query\UnitOfMeasure\GetUnitOfMeasures\GetUnitsOfMeasureQueryHandler;
...
class UnitsOfMeasureQueryHandlerTest extends TestCase
{
    ...
    private GetUnitsOfMeasureQueryHandler $handler;

    protected function setUp(): void
    {
        $this->pager = $this->createMock(UnitsOfMeasureItemsPager::class);
        $this->handler = new GetUnitsOfMeasureQueryHandler($this->pager);
    }
    ...
    public function it_returns_a_response_with_mapped_dto(): void
    {
        ...
        $response = ($this->handler)(new GetUnitsOfMeasureQuery(0,20));
    ...
    public function it_forwards_offset_and_limit_to_the_pager(): void
    {
        ...
        $response = ($this->handler)(new GetUnitsOfMeasureQuery(0,5));
        $this->assertCount(0, $response->items);
    }
}
